...
def _get_section_signal(text: str, skill_start: int, window: int = 600) -> str:
    ...
    'unknown' means no signal was found — callers should treat it as 'required'
    but it allows future callers to distinguish "definitely required" vs "assumed".
    """
...
def extract_skills(description: str) -> dict[str, list[str]]:
    ...
    for match_id, start, end in matches:
        ...
        else:   # "required" or "unknown" — default to required
